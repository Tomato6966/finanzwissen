...
export const WithdrawalPlanCalculator: FC = () => {
    const [withdrawalMode, setWithdrawalMode] = useState<'fixed' | 'max'>('fixed');
    const [maxWithdrawalSettings, setMaxWithdrawalSettings] = useState({ strategy: 'endless', years: 20 });
            ...
            <CardContent className="grid md:grid-cols-3 gap-8 pb-6">
                <div className="md:col-span-1 space-y-4">
                    <div>
                        ...
                        <Input id="principal" name="principal" type="number" value={withdrawalForm.principal} onChange={handleFormChange(setWithdrawalForm)} />
                    </div>
                    <div>
                        <Label htmlFor="rate">Erwartete Rendite p.a. (%)</Label>
                        <Input id="rate" name="rate" type="number" step="0.1" value={withdrawalForm.rate} onChange={handleFormChange(setWithdrawalForm)} />
                    </div>
                    <div>
                        ...
                        <Input id="tax" name="tax" type="number" step="0.1" value={withdrawalForm.tax} onChange={handleFormChange(setWithdrawalForm)} />
                    </div>
                    ...
                    {withdrawalMode === 'fixed' ? (
                        <div>
                            ...
                            <Input id="withdrawal" name="withdrawal" type="number" value={withdrawalForm.withdrawal} onChange={handleFormChange(setWithdrawalForm)} />
                        </div>
                    ) : (
