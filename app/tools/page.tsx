    ...
    return (
        <div className="space-y-12 p-4 md:p-8 lg:p-12 max-w-7xl mx-auto">
            ...
            <div className="text-center">
                <h1 className="text-4xl font-bold text-foreground mb-4">Tools & Ressourcen</h1>
                ...
                <TabsList className="flex flex-wrap justify-center w-full gap-2 h-auto p-2 bg-muted">
                    {TOOL_CATEGORIES.map((category) => (
                        <TabsTrigger
                            key={category.id}
                            value={category.id}
                            className="flex-1 min-w-[20%] bg-primary/10 text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"
                        >
