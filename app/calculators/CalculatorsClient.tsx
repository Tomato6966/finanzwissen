...
export default function CalculatorsClient() {
    ...
    return (
        <div className="p-4 md:p-8 bg-gray-50 font-sans rounded-md">
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full max-w-6xl mx-auto">
                <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 h-auto p-2 bg-slate-300">
                    <TabsTrigger value="compound"><TrendingUp /> Zinseszins</TabsTrigger>
                    <TabsTrigger value="withdrawal"><TrendingDown /> Entnahmeplan</TabsTrigger>
                    <TabsTrigger value="retirement"><TrendingUpDown/>  Vorsorge</TabsTrigger>
                    <TabsTrigger value="goals"><PiggyBank /> Sparziele</TabsTrigger>
                    <TabsTrigger value="montecarlo"><BarChart2 /> Monte Carlo</TabsTrigger>
                </TabsList>
