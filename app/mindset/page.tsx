            ...
            <CardContent>
                <div className="space-y-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Geld, das Sie aktiv verdienen (Gehalt, Freelancing)</p>
                    </div>
                    <div>
                        <h4 className="font-semibold text-purple-600 mb-1">Vermögen</h4>
                        <p className="text-sm text-muted-foreground">Alles was Sie besitzen (Immobilien, Aktien, Sparguthaben)</p>
                    </div>
                    <div>
